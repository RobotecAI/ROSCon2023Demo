...
namespace ROS2::Demo
{
   ...
   void ScriptSpawnLevelComponent::SpawnAsset(const AZ::Data::Asset<AzFramework::Spawnable>& spawnable, const AZ::Transform& transform, const AZStd::string& spawnableName)
   {
