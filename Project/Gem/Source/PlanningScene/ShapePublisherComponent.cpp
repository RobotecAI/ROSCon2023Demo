...
namespace ROSCon2023Demo
{
    ...
    moveit_msgs::msg::CollisionObject ShapePublisherComponent::CreateBoxCollisionObject()
    {
        ...
        AZ_Warning(
            ...
            !isAxisAligned,
            "Axis Aligned Box is not supperted. Object %s may be incorrectly aligned.",
            m_objectId.c_str());
            ...
            if (AZ::EditContext* editContext = serializeContext->GetEditContext())
            {
                editContext->Class<ShapePublisherComponent>("ShapePublisherComponent", "Publishes CollisionObject data about shape.")
                    ...
                    ->DataElement(
                        ...
                        "Topic Namespace",
                        "Namespace of topic on which CollisionObject messages will be sent.)")
                    ->DataElement(
                        AZ::Edit::UIHandlers::Default,
                        &ShapePublisherComponent::m_topicName,
                        "Topic Name",
                        "Name of topic on which CollisionObject messages will be sent.");
            }
        }
    }
