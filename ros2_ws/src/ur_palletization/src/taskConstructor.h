...
namespace Palletization {
    ...
    public:
        ...
        RoboticArmController(std::shared_ptr<moveit::planning_interface::MoveGroupInterface> moveGroupInterface,
                             std::string ns);
        ...
        bool
        setPosePIP(const Eigen::Vector3d &tcp_position, const Eigen::Quaterniond &tcp_orientation, float speed = 0.75f,
